...
class pila_int:private lse_int{
	public:
		void poner(void);
		void quitar(void);
		void estado(void); 
...
void pila_int::poner(void){
	insertarInicio();
}
void pila_int::quitar(void){
	eliminarInicio();
}
void pila_int::estado(void){
	if(inicio==NULL){
		cout<<"\nLa pila esta vacia";
	}
	else{
...
void pila_int::imprimirPila(void){
	imprimir();
}
//**********Fin de la implementacion de clase pila_int**********
int main(void){
	pila_int pila;
